...
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Novacoin Core
#include <util/string.h> // Added for Novacoin Core
...
// Added for Novacoin Core. Wrapper for checking format strings at compile time.
