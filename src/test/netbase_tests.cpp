...
{
    BOOST_CHECK(TestSplitHost("www.novacoincore.org", "www.novacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.novacoincore.org]", "www.novacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.novacoincore.org:80", "www.novacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.novacoincore.org]:80", "www.novacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::9191", "::9191", 0));
    BOOST_CHECK(TestSplitHost(":9191", "", 9191));
    BOOST_CHECK(TestSplitHost("[]:9191", "", 9191));
    ...
    BOOST_CHECK(TestSplitHost("www.novacoincore.org:65536", "www.novacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.novacoincore.org:0", "www.novacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.novacoincore.org:", "www.novacoincore.org:", 0, false));
}
