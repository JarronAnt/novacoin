...
```sh
cmake --build build --target novacoind novacoin-cli
cmake --build build --target novacoin-qt
cmake --build build --target bench_novacoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:novacoin/novacoin.git
```
