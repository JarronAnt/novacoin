...
This guide describes how to build novacoind, command-line utilities, and GUI on OpenBSD.
...
It is not necessary to build wallet functionality to run either `novacoind` or `novacoin-qt`.
...
...
to: /path/to/novacoin/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/novacoin/novacoin/issues/6658)).
