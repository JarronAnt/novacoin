...
router", implementing the novacoin wire protocol and relay, making
...
terminator). These options can also be provided in novacoin.conf.
...
From the perspective of novacoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into novacoind directly. Furthermore, no information is
