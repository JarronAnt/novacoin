// Copyright (c) 2014-2020 The Novacoin Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between novacoin-cli and novacoind)
 * of a given instance of the Novacoin system.
 */
