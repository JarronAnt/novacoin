Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://novacoin.org/bin/novacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update novacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow novacoin-tx to create v2 transactions (btcdrak)
