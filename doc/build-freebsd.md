...
This guide describes how to build novacoind, command-line utilities, and GUI on FreeBSD.
...
```
to: /path/to/novacoin/depends/x86_64-unknown-freebsd[release-number]
```
