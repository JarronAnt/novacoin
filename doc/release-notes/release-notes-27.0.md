Bitcoin Core version 27.0 is now available from:
  ...
  <https://novacoincore.org/bin/novacoin-core-27.0/>
...
libnovacoinconsensus
-------------------

- libnovacoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libnovacoinkernel will provide a much more useful API that is
