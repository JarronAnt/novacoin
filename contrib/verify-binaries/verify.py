...
signature file SHA256SUMS.asc from novacoincore.org and novacoin.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/novacoin-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://novacoincore.org"
HOST2 = "https://novacoin.org"
VERSIONPREFIX = "novacoin-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"novacoin_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by novacoincore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the novacoin release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes novacoin.org lags behind novacoincore.org.)')
    )
