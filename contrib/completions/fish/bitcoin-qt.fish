...
complete --command novacoin-qt --no-files

# Extract options
function __fish_novacoinqt_get_options
...
complete \
    --command novacoin-qt \
    --arguments "(__fish_novacoinqt_get_options --nofiles)"
