...
BITCOIND=${BITCOIND:-$BINDIR/novacoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/novacoin.conf}
...
then
  ...
  echo -e "To safely generate a novacoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example novacoin.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-novacoin-conf.sh.
##
...
# parse the output from novacoind --help
