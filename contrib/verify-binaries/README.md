...
of the [guix.sigs repository](https://github.com/novacoin-core/guix.sigs/). When
...
builder-keys](https://github.com/novacoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://novacoincore.org and https://novacoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/novacoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/novacoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
