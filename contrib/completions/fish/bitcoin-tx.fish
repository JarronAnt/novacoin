...
# Extract options
function __fish_novacoin_tx_get_options
...
# Extract commands
function __fish_novacoin_tx_get_commands
...
complete \
    --command novacoin-tx \
    --condition "not __fish_novacoin_seen_cmd (__fish_novacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_novacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command novacoin-tx \
    --arguments "(__fish_novacoin_tx_get_commands)" \
    --no-files
