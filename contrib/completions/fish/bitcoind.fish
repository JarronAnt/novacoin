...
complete --command novacoind --no-files

# Extract options
function __fish_novacoind_get_options
...
complete \
    --command novacoind \
    --arguments "(__fish_novacoind_get_options --nofiles)"
