// Copyright (c) 2018-2022 The Novacoin Core developers
...
//! Entry point for NovacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NovacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NovacoinGUI tests.
void AppTests::guiTests(NovacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NovacoinGUI::consoleShown, this, &AppTests::consoleTests);
