// Copyright (c) 2011-2022 The Novacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <novacoin-build-config.h> // IWYU pragma: keep

#include <qt/novacoingui.h>

#include <qt/novacoinunits.h>
...
const std::string NovacoinGUI::DEFAULT_UIPLATFORM =
...
NovacoinGUI::NovacoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &NovacoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &NovacoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &NovacoinGUI::showModalOverlay);
...
void NovacoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Novacoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and novacoin: URIs)"));
    ...
    connect(overviewAction, &QAction::triggered, this, &NovacoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &NovacoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &NovacoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Novacoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Novacoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a novacoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Novacoin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &NovacoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &NovacoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &NovacoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &NovacoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &NovacoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &NovacoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &NovacoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &NovacoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &NovacoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &NovacoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &NovacoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &NovacoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &NovacoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &NovacoinGUI::showDebugWindow);
}

void NovacoinGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void NovacoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &NovacoinGUI::setCurrentWalletBySelectorIndex);
...
void NovacoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &NovacoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &NovacoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &NovacoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &NovacoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void NovacoinGUI::enableHistoryAction(bool privacy)
{
...
void NovacoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &NovacoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &NovacoinGUI::removeWallet);
...
WalletController* NovacoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void NovacoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &NovacoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &NovacoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &NovacoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &NovacoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &NovacoinGUI::incomingTransaction);
    connect(this, &NovacoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void NovacoinGUI::removeWallet(WalletModel* walletModel)
{
...
void NovacoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void NovacoinGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void NovacoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void NovacoinGUI::setWalletActionsEnabled(bool enabled)
{
...
void NovacoinGUI::createTrayIcon()
{
...
void NovacoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &NovacoinGUI::toggleHidden);
...
void NovacoinGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void NovacoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void NovacoinGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void NovacoinGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void NovacoinGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void NovacoinGUI::openClicked()
{
...
void NovacoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void NovacoinGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void NovacoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void NovacoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void NovacoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void NovacoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void NovacoinGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void NovacoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Novacoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void NovacoinGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void NovacoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void NovacoinGUI::updateHeadersSyncProgressLabel()
{
...
void NovacoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void NovacoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &NovacoinGUI::quitRequested);
...
void NovacoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void NovacoinGUI::createWallet()
{
    ...
    connect(activity, &CreateWalletActivity::created, this, &NovacoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void NovacoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void NovacoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &NovacoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &NovacoinGUI::show);
                e->ignore();
            }
        }
    }
...
void NovacoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void NovacoinGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void NovacoinGUI::incomingTransaction(const QString& date, NovacoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(NovacoinUnits::formatWithUnit(unit, amount, true));
...
void NovacoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void NovacoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool NovacoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool NovacoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void NovacoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void NovacoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void NovacoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void NovacoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void NovacoinGUI::updateWindowTitle()
{
...
void NovacoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void NovacoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void NovacoinGUI::detectShutdown()
{
...
void NovacoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void NovacoinGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(NovacoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = NovacoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void NovacoinGUI::subscribeToCoreSignals()
{
...
void NovacoinGUI::unsubscribeFromCoreSignals()
{
...
bool NovacoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<NovacoinUnit> units = NovacoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const NovacoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, NovacoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const NovacoinUnit u : NovacoinUnits::availableUnits()) {
        menu->addAction(NovacoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(NovacoinUnit newUnits)
{
    setText(NovacoinUnits::longName(newUnits));
}
