...
"""Verify that starting novacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start novacoin with -h for help text")
        ...
        self.log.info("Start novacoin with -version for version information")
        ...
        self.log.info("Start novacoind with -fakearg to make sure it does not start")
