Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://novacoin.org/bin/novacoin-core-0.11.0/>
...
For example, add the following to `novacoin.conf`:
...
related to the blockchain in the novacoin system: the raw blocks as received over 
...
For an example script see [novacoin-submittx](https://github.com/laanwj/novacoin-submittx).
...
- #5334 `cf87536` libnovacoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new novacoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add novacoin logo to about screen
...
- #5809 `46bfbe7` Add novacoin-cli man page
...
- #5849 `41259ca` contrib/init/novacoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for novacoin-tx)
