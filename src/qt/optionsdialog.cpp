      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->novacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->novacoinAtStartup);
    ...
    ui->novacoinAtStartup->setToolTip(ui->novacoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->novacoinAtStartup->setText(ui->novacoinAtStartup->text().arg(CLIENT_NAME));

    ui->openNovacoinConfButton->setToolTip(ui->openNovacoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new NovacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->novacoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSNOControls);
...
void OptionsDialog::on_openNovacoinConfButton_clicked()
{
