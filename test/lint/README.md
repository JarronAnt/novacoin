...
```sh
DOCKER_BUILDKIT=1 docker build -t novacoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/novacoin -it novacoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/novacoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/novacoin-core/leveldb-subtree.git (branch novacoin-fork)
* for `src/crypto/ctaes`: https://github.com/novacoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/novacoin-core/crc32c-subtree.git (branch novacoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/novacoin-core/secp256k1.git
```
