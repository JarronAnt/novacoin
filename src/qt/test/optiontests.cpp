...
{
    // Test regression https://github.com/novacoin/novacoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/novacoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/novacoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Novacoin/Novacoin-Qt.conf and all else left as default,
    // novacoin-qt should set both -listen and -listenonion to false and start successfully.
