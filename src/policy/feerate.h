...
const std::string CURRENCY_UNIT = "NOC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    NOC_KVB,      //!< Use NOC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::NOC_KVB) const;
