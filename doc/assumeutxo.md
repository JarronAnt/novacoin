...
Assumeutxo is a feature that allows fast bootstrapping of a validating novacoind
instance.
...
```
$ novacoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ novacoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
