// Copyright (c) 2016-2022 The Novacoin Core developers
...
// queue, which doesn't exist for the novacoin-wallet. Define our own
// deleter here.
...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        tfm::format(std::cout, "The dumpfile may contain private keys. To ensure the safety of your Novacoin, do not share the dumpfile.\n");
        return ret;
