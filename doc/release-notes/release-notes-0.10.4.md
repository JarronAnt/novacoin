Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://novacoin.org/bin/novacoin-core-0.10.4/>
...
- #6953 `43c2789` Split novacoin-tx into its own package
- #6953 `dfe0d4d` Include novacoin-tx binary on Debian/Ubuntu
