...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"novacoin-cli -h\" for help or \"novacoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `novacoin-cli getblockchaininfo`")
        ...
        # Prevent novacoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and novacoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and novacoin-cli getwalletinfo return expected wallet info")
            ...
            # Test novacoin-cli -generate with -rpcwallet in multiwallet mode.
