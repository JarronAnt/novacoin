Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/novacoin/files/Bitcoin/novacoin-0.7.0/

We recommend that everybody running prior versions of novacoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/novacoin/novacoin/tarball/v0.7.0  # .tar.gz
  https://github.com/novacoin/novacoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the novacoin-qt package:
  sudo apt-get install novacoin-qt
...
Core novacoin handling and blockchain database
...
* Ensure a changed novacoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for novacoin-qt.exe
* (Windows only): add meta-data to novacoin-qt.exe (e.g. description)
...
* Bash programmable completion for novacoind(1)
