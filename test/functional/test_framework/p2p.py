...
"""Test objects for interacting with a novacoind node over the p2p protocol.

The P2PInterface objects interact with the novacoind nodes under test using the
