...
"""Test framework for novacoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "novacoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./novacoin-util":
        execprog = os.getenv("BITCOINUTIL", default=execprog)
    elif testObj["exec"] == "./novacoin-tx":
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, novacoin-tx
