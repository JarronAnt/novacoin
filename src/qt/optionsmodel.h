...
/** Interface from Qt to configuration data structure for Novacoin client.
...
public:
    ...
    NovacoinUnit getDisplayUnit() const { return m_display_novacoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSNOControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    NovacoinUnit m_display_novacoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(NovacoinUnit unit);
